            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-3xl border border-gray-100 shadow-sm p-6">
                    ...
                    <div class="pt-4 border-t border-gray-100">
                        <a href="{{ route('medico.security-questions') }}" class="flex items-center justify-between p-4 bg-amber-50 rounded-xl border border-amber-100 hover:bg-amber-100 transition-colors group">
    ...
    @if(session('error_password'))
        document.addEventListener('DOMContentLoaded', () => {
             if (typeof createToast === 'function') {
                ...
                console.error('createToast function not found in layout');
            }
        });
    @endif
